...
$EmailFrom = "avnis389@gmail.com";   //your first email from where you want to send email
$EmailTo = "arindambose975@gmail.com";   //your second email where you want to receive contact form content
